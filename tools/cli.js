...
var project_creator = require(path.join(__dirname, "../node_modules/punch/lib/project_creator.js"));
var generator = require(path.join(__dirname, "../node_modules/punch/lib/site_generator.js"));
var server = require(path.join(__dirname, "./punch-proxy-server.js"));
var publisher = require(path.join(__dirname, "../node_modules/punch/lib/publisher.js"));
var config_handler = require(path.join(__dirname, "../node_modules/punch/lib/config_handler.js"));
...
module.exports = {
  ...
  version: function() {
		...
		self.notifyIfOutdated(function() {
			var package_meta = require("../node_modules/punch/package.json");
